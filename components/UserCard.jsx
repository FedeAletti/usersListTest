...
export const UserCard = ({ user }) => {
    return (
        <div className="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 px-5">
            ...
            <div className="flex flex-col items-center pb-10">
                <Image width={100} height={100} className="rounded-full w-32" src={user.avatar} alt="Bonnie image" />
